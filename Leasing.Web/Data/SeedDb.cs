...
namespace Leasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Tito", "Parra", "tito.parra4@hotmail.com", "508 797 983", "Magiera 17", "Manager");
            var owner = await CheckUserAsync("2020", "Tito", "Parra", "tito.parra4@gmail.com", "508 797 983", "Magiera 17", "Owner");
            var lessee = await CheckUserAsync("3030", "Tito", "Parra", "tito.parra@marvtek.com", "508 797 983", "Magiera 17", "Lessee");
